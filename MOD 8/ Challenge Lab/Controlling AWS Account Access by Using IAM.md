...
![image](https://user-images.githubusercontent.com/126258837/235697260-80669ec0-c9ad-4992-b706-b8904d598a66.png)
...
Try to reboot the aws-cloud9-DEVCafeServer instance
 ...
 Tip: To find the Reboot option, select the instance and look in the Instance state menu.
...
https://us-east-1.console.aws.amazon.com/cloud9/ide/c0638dd40873474bbeb4afc9b3551c77
...
28. Open the Amazon EC2 console and choose Instances (running).
...
- Notice that you can see which service areas that Olivia visited. Recent service activity usually appears within 4 hours (as stated in the Access Advisor details). You might not see any Last accessed data for Olivia yet.
 ...
 You can use this view to gain insight into how a user's permissions might be more open than they should be. This information enables you to more closely align access rights with the [principle of least privilege](https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html#grant-least-privilege) .
